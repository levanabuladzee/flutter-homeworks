import 'package:homework_task_3/model/planet.dart';
...
class Planets {
  ...
  Planets() {
    ...
    _list.add(new Planet("Mars", "https://upload.wikimedia.org/wikipedia/commons/0/02/OSIRIS_Mars_true_color.jpg", "The planet is named after Mars, the Roman god of war. It was known to the ancient Greeks as Ares, their god of war."));
  }
